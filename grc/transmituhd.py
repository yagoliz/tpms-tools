...
class transmituhd(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "UHD  WavFile Transmitter", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("UHD  WavFile Transmitter")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "transmituhd")
...
def main(top_block_cls=transmituhd, options=None):
